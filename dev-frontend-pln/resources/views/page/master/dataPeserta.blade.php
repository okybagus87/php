            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="dt-responsive table-responsive">
                        <table class="table table-striped table-bordered nowrap" id="dttable">
                            <thead>
                                <tr>
                                    <th>No</th>
                                    <th>Nama</th>
                                ...
                                @foreach ($peserta->data as $data)
                                    @if ($data->attributes->role == 'Peserta')
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    <a href="dataPeserta/getPesertaById/{{ Crypt::encryptString($data->id) }}">
                                                        <button type="button" class="btn bg-teal btn-xs" title="Edit" id="btnEdit">
                                                            <i class="fas fa-pen"></i>
                                                        </button>
                                                    </a>
                                                    <a href="#delModal" data-id="{{Crypt::encryptString($data->id)}}" data-toggle="modal">
                                                        <button type="button" class="btn bg-pink btn-xs" title="Hapus">
        ...
        $(document).ready(function() {
            var table = $('#dttable').DataTable({
                ...
                "rowCallback": function( row, data, index ) {
                    if (index % 2 == 0) {
                        $('td', row).css('background-color', '#ecf5ff');
                    }
                }
            });
